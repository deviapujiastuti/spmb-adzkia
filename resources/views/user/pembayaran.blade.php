...
<body class="bg-brand-bg antialiased text-brand-dark min-h-screen flex flex-col" x-data="paymentApp()">
    ...
    <nav class="w-full bg-white py-8 border-b border-gray-100 sticky top-0 z-50">
        <div class="max-w-5xl mx-auto px-6">
            <div class="flex items-center justify-between relative">
                ...
                <div class="absolute top-5 left-0 h-0.5 bg-brand-dark z-0 transition-all duration-500" style="width: 16.6%;"></div>
    ...
    <main class="flex-1 max-w-3xl mx-auto w-full px-6 py-12">
        <div class="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl shadow-brand-dark/5 border border-gray-100">
            ...
            <div class="mb-10">
                <h1 class="text-3xl font-black text-brand-dark tracking-tight mb-4">Biaya Pendaftaran</h1>
                <div class="flex items-center gap-2">
                    <span class="px-3 py-1 bg-brand-blue-light text-brand-blue rounded-md text-[10px] font-black uppercase tracking-widest">S1 Informatika</span>
            ...
            <div class="bg-[#F8FAFC] rounded-2xl p-6 md:p-8 mb-10 border border-gray-100 space-y-4">
                <div class="flex justify-between items-center text-[14px] font-bold text-gray-500">
                    ...
                    <span class="text-brand-dark">Rp 250.000</span>
                </div>
                <div class="w-full h-px bg-gray-200"></div>
                <div class="flex justify-between items-center">
                    <span class="text-[14px] font-bold text-gray-500">Total Pembayaran</span>
                    <span class="text-2xl font-black text-brand-dark">Rp 250.000</span>
                </div>
            </div>
            ...
            <div class="mb-10">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <button @click="method = 'bank'" 
                            ...
                            :class="method === 'bank' ? 'border-brand-dark bg-white shadow-md' : 'border-gray-100 bg-white hover:border-gray-200'">
                        <i data-feather="monitor" class="w-5 h-5 text-brand-dark"></i>
                        <span class="text-[13px] font-extrabold text-brand-dark">Bank Transfer</span>
                    </button>
                    ...
                    <button @click="method = 'va'" 
                            ...
                            :class="method === 'va' ? 'border-brand-dark bg-white shadow-md ring-2 ring-brand-dark/5' : 'border-gray-100 bg-white hover:border-gray-200'">
                        <div class="flex items-center gap-3">
                            <i data-feather="credit-card" class="w-5 h-5 text-brand-dark"></i>
                            <span class="text-[13px] font-extrabold text-brand-dark">Virtual Account</span>
                        </div>
                        <div x-show="method === 'va'" class="text-brand-dark">
                    ...
                    <button @click="method = 'ewallet'" 
                            class="p-4 rounded-2xl border-2 flex items-center gap-3 transition-all duration-200"
                            :class="method === 'ewallet' ? 'border-brand-dark bg-white shadow-md' : 'border-gray-100 bg-white hover:border-gray-200'">
                        <i data-feather="smartphone" class="w-5 h-5 text-brand-dark"></i>
                        <span class="text-[13px] font-extrabold text-brand-dark">E-Wallet</span>
                    </button>
                ...
                <div class="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100 mb-10">
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <h4 class="text-[15px] font-extrabold text-brand-dark">Bank Mandiri</h4>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center justify-between">
                            <h2 class="text-2xl md:text-3xl font-black text-brand-dark tracking-widest">8829 1029 3847 221</h2>
                            <button @click="copyVA('882910293847221')" class="flex items-center gap-1.5 text-[13px] font-black text-brand-dark hover:text-brand-blue transition-colors">
                    ...
                    <div class="mb-8">
                        ...
                        <h4 class="text-[15px] font-extrabold text-brand-dark">SPMB ADMISSION</h4>
                    </div>

                    <div class="bg-red-50/80 border border-red-100 rounded-2xl p-5 flex gap-4 items-start">
                        <i data-feather="info" class="w-5 h-5 text-red-500 shrink-0 mt-0.5"></i>
            ...
            <div class="flex flex-col items-center gap-4">
                <button @click="bayarSekarang()" class="w-full py-4 bg-brand-dark text-white rounded-2xl font-black text-[15px] hover:bg-brand-blue shadow-lg shadow-brand-dark/20 transition-all active:scale-[0.98]">
                    Bayar Sekarang
                </button>
                <a href="/register" class="text-[13px] font-extrabold text-gray-500 hover:text-brand-dark transition-colors py-2">
                    Kembali
                </a>
            </div>
