                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-4 py-4 text-center">
                            ...
                            @elseif($data->status_kelulusan == 'Tidak Lulus')
                                <span class="px-3 py-1 bg-red-50 text-red-600 rounded-full text-[10px] font-black uppercase">{{ $data->status_kelulusan }}</span>
                            @else
                                <span class="px-3 py-1 bg-green-50 text-green-600 rounded-full text-[10px] font-black uppercase">{{ $data->status_kelulusan }}</span>
                            @endif
                        </td>
                        <td class="px-6 py-4 text-center">
                            <button @click="bukaModal('{{ $data->id }}', '{{ addslashes($data->nama_lengkap) }}', '{{ $data->no_pendaftaran }}', '{{ $data->pilihan_jurusan_1 }}', '{{ $data->pilihan_jurusan_2 }}', '{{ $data->status_kelulusan }}')" 
